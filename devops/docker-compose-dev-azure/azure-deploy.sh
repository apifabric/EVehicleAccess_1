...
resourcename="evehicleaccess1"  # lower case, only
resourcegroup="evehicleaccess1_rg"
...
# git clone https://github.com/apilogicserver/evehicleaccess1.git
# cd evehicleaccess1
...
az group create --name evehicleaccess1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group evehicleaccess1_rg --sku S1 --is-linux
az container create --resource-group evehicleaccess1_rg --name evehicleaccess1 --image apilogicserver/evehicleaccess1:latest --dns-name-label evehicleaccess1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//evehicleaccess1.westus.azurecontainer.io:5656'
